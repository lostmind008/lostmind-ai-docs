...
description: 'Configure branding and navigation using the mint.json file'
icon: 'gear'
---

Every site uses a `mint.json` file for core configuration. Key properties are below.
...
Example: `LostMind AI Documentation`
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `mailto:hello@lostmindai.com`
    </ResponseField>
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Enable or hide the playground UI for endpoints
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "x": "https://x.com/lostmindai",
    "website": "https://lostmindai.com"
  }
  ```
  <Expandable title="FooterSocials">
    ...
    Example: `https://x.com/lostmindai`
    </ResponseField>
  </Expandable>
</ResponseField>
